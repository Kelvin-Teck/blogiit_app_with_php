...
$post_query = "SELECT id, title, category_id FROM posts  WHERE author_id = $current_user_id ORDER BY id DESC";
...
<section class="dashboard">
    <?php if(isset( $_SESSION['add-post-success'])) : // show when add-post was successfull...?>
        <div class="alert__message success container">
            <p><?= $_SESSION['add-post-success']; unset($_SESSION['add-post-success']) ?></p>
        </div>
    <?php elseif(isset( $_SESSION['edit-post-success'])) : // show when edit-post was successfull...?>
        <div class="alert__message success container">
            <p><?= $_SESSION['edit-post-success']; unset($_SESSION['edit-post-success']) ?></p>
        </div>
    <?php elseif(isset( $_SESSION['edit-post'])) : // show when edit-post was not successfull...?>
        <div class="alert__message error container">
            <p><?= $_SESSION['edit-post']; unset($_SESSION['edit-post']) ?></p>
        </div>
    <?php elseif(isset( $_SESSION['delete-post-success'])) : // show when delete-post was successfull...?>
        <div class="alert__message success container">
            <p><?= $_SESSION['delete-post-success']; unset($_SESSION['delete-post-success']) ?></p>
        </div>
    <?php elseif(isset( $_SESSION['delete-post'])) : // show when delete-post was not successfull...?>
        <div class="alert__message error container">
            <p><?= $_SESSION['delete-post']; unset($_SESSION['delete-post']) ?></p>
        </div>
    <?php elseif(isset( $_SESSION['delete-category-success'])) : // show when delete-category was successfull...?>
        <div class="alert__message success container">
            <p><?= $_SESSION['delete-category-success']; unset($_SESSION['delete-category-success']) ?></p>
        </div>
    <?php elseif(isset( $_SESSION['delete-category'])) : // show when delete-category was not successfull...?>
        <div class="alert__message error container">
            <p><?= $_SESSION['delete-category']; unset($_SESSION['delete-category']) ?></p>
        </div>
    <?php endif; ?>
            ...
            <table>
                ...
                <tbody>
                    <?php while($post = mysqli_fetch_assoc($posts)) :?>
                        <!-- get the post category from the categories table... -->
                        <?php 
